...
$subject = "Lead Generation - заявка на консультацию."; // Тема письма - заголовок
...
echo '<center><br><br><h2>Не введен или неправильно введен e-mail!</h2><br><b>Вы ввели: </b><i>';
$email=trim($email); //удал пробелы
$email=htmlspecialchars($email); //удаляем теги html
echo "$email</i>";
echo "<br><a href=# onClick='history.back()'>Вернуться назад</a></center>";
exit();
}
// Проверка правильности ввода E-MAIL
...
$From = "=?windows-1251?b?" . base64_encode("Lead Generation") . "?= <" . "lg@bernerandstafford.ru" . ">";
