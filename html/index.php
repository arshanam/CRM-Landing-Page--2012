...
<header class="header">
	...
	<div class="sidebar">		
		<div class="side_form">
			...
			<p class="f_line_text">Город</p>
			<div class="form_line"><input type="text" name="city" id="city1" class="f_line"></div>		
			<p class="f_line_text">Название компании</p>
			<div class="form_line"><input type="text" name="company" id="company1" class="f_line"></div>
			<p class="f_line_text">Должность</p>
			<div class="form_line"><input type="text" name="position" id="position1" class="f_line"></div>		
